   ...
   <footer className="mx-auto max-w-3xl px-4 sm:px-6 md:max-w-5xl md:mt-[50px]">
    ...
    <div className="mx-auto p-4 flex flex-col text-center text-neutral-900 md:flex-row md:justify-between">
        <div className="flex flex-row items-center justify-center space-x-1 text-neutral-500 dark:text-neutral-100">
            @ 2023 Arif Khan <a href="/" className='hover:unde
            '></a>
        </div>
        <div className="flex flex-row items-center justify-center space-x-2 mb-1">
            <a href="https://github.com/arifkhan1990" rel="noreferrer" target="_blank">
            ...
            <a href="https://bd.linkedin.com/in/arif-khan-2b4b23118" rel="noreferrer" target="_blank">
            ...
            <a href="https://github.com/arifkhan1990" rel="noreferrer" target="_blank">
                <AiOutlineInstagram className="hover:-translate-y-1 transition-transform cursor-pointer text-neutral-500 dark:text-neutral-100" size={30} />
            </a>
